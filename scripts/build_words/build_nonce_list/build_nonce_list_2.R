...
write_tsv(n4, 'resource/nonce_words/nouns1.tsv')
write_tsv(v_1syl_3, 'resource/nonce_words/verbsshort1.tsv')
write_tsv(v_2syl_3, 'resource/nonce_words/verbslong1.tsv')
