...
ik_old = read_csv('src/ik_verbs/ikes_pairs_webcorpus1.csv')
...
vh_old = read_delim('src/front_harmony/fh_pairs_webcorpus1.csv', delim = ';')
...
hang = read_tsv('src/epenthetic_stems/epenthesis_pairs_webcorpus2.tsv')
hang_old = read_csv('src/epenthetic_stems/epenthesis_pairs_webcorpus1.txt')
