...
![Matching 1](analysis/esp_analysis/preds/pred1.png)

![Matching 2](analysis/esp_analysis/preds/pred2.png)

![Matching 3](analysis/esp_analysis/preds/pred3.png)

### Post test

`picked_v1 ~ 1 + reg_rate + reg_dist * baseline_log_odds_jitter + variation + (1 + 1|part_id) + (1|base)`

![post 1](analysis/esp_analysis/preds/pred4.png)

![post 2](analysis/esp_analysis/preds/pred5.png)

![post 3](analysis/esp_analysis/preds/pred6.png)
