...
We see a similar pattern in Figure 12, which shows raw target form log odds for the baseline, the first posttest, and the second posttest of the integration task, across the two patterns. Log odds decrease upon meeting the "low" co-player, and they slightly recover a day later, but the shift is not statistically significant.

![Figure 12](analysis/esp_analysis/preds/pred23.png)
